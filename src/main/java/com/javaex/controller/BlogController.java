...
public class BlogController {
	...
	public String adminCategory(@PathVariable("id") String id, HttpSession session) {
	...
	public String adminWriteForm(@PathVariable("id") String id, HttpSession session,  Model model) {
